...
The main file (including all analyses run in Rstudio) is listed as "RstudioFile". Ruellia simplex is reffered to by synonym Ruellia brittoniana. This has demo code for calculating species averages from individual averages, ANOSIM analyses at the species and individual levels, phylogenetic signal testing using Moran's I and 
